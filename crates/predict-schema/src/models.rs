use crate::schema::{
    ...
    oracle_prices_updated, oracle_settled, oracle_svi_updated, position_minted, position_redeemed,
    predict_created, predict_manager_created, pricing_config_updated, quote_asset_disabled,
    quote_asset_enabled, range_minted, range_redeemed, risk_config_updated, supplied,
    trading_pause_updated, withdrawn,
};
