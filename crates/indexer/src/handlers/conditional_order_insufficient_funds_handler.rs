...
use crate::models::deepbook_margin::tpsl::ConditionalOrderInsufficientFunds as ConditionalOrderInsufficientFundsEvent;
use deepbook_schema::models::ConditionalOrderInsufficientFunds;

define_handler! {
    name: ConditionalOrderInsufficientFundsHandler,
    processor_name: "conditional_order_insufficient_funds",
    event_type: ConditionalOrderInsufficientFundsEvent,
    db_model: ConditionalOrderInsufficientFunds,
    table: conditional_order_insufficient_funds,
    map_event: |event, meta| ConditionalOrderInsufficientFunds {
