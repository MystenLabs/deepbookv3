...
impl StakesHandler {
    pub fn new() -> Self {
        Self {
            event_type: convert_struct_tag(StakeEvent::struct_type()),
        }
    }
}
            ...
            .try_fold(vec![], |result, tx| {
                ...
                return events
                    ...
                    .try_fold(result, |mut result, (index, ev)| {
                        ...
                        debug!("Observed Deepbook Stake Event {:?}", data);
                        result.push(data);
                        Ok(result)
                    });
            })
