...
use crate::models::MarketConfigSnapshot as Ev;
use bigdecimal::BigDecimal;
use predict_schema::models::MarketConfigSnapshot as Row;
...
crate::define_predict_handler! {
    name: MarketConfigSnapshotHandler,
    processor_name: "market_config_snapshot",
    event_type: crate::models::MarketConfigSnapshot,
    db_model: predict_schema::models::MarketConfigSnapshot,
    table: market_config_snapshot,
