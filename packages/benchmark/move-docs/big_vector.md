...
-  [Function `contains`](#0x0_big_vector_contains)
...
<a name="0x0_big_vector_contains"></a>

## Function `contains`



<pre><code><b>public</b> <b>fun</b> <a href="big_vector.md#0x0_big_vector_contains">contains</a>&lt;E: store&gt;(self: &<a href="big_vector.md#0x0_big_vector_BigVector">big_vector::BigVector</a>&lt;E&gt;, key: u128): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="big_vector.md#0x0_big_vector_contains">contains</a>&lt;E: store&gt;(self: &<a href="big_vector.md#0x0_big_vector_BigVector">BigVector</a>&lt;E&gt;, key: u128): bool {
    <b>if</b> (self.root_id == <a href="big_vector.md#0x0_big_vector_NO_SLICE">NO_SLICE</a>) {
        <b>return</b> <b>false</b>
    };

    <b>let</b> (ref, off) = self.<a href="big_vector.md#0x0_big_vector_slice_following">slice_following</a>(key);
    <b>if</b> (ref.is_null()) <b>return</b> <b>false</b>;
    <b>let</b> slice = self.<a href="big_vector.md#0x0_big_vector_borrow_slice">borrow_slice</a>(ref);

    off &lt; slice.<a href="big_vector.md#0x0_big_vector_length">length</a>() && key == slice.key(off)
}
</code></pre>
