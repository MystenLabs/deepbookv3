...
| Market-lifecycle operator (`MarketLifecycleCap`) | Creating future expiry markets and starting the pool flush as a deployer | Cannot write prices or any oracle data, move custody, or mint/redeem; admin-revocable on the registry allowlist |
