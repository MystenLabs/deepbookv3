...
- **Aggregate NAV still rests on keeper timeliness.** The pending-protocol-profit exclusion underflow is now structurally clamped, and the above-floor NAV precondition is backed by the verified-floor haircut plus the withdraw band fee — but the residual described under LP risk (fee-attenuated overstatement during a budget-out-running stress move) is accepted, not eliminated.
