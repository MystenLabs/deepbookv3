...
// === Expiry Trading Loss Rebates ===

/// Maximum expiry trading loss rebate as a fraction of pool trading fees paid.
public macro fun expiry_trading_loss_rebate_rate(): u64 { 500_000_000 }
