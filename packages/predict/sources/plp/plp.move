...
const EValuationSnapshotNotSealed: u64 = 9;
const EExpiryPricerAlreadySnapshotted: u64 = 10;
const EIncompleteValuationSnapshot: u64 = 11;
const EExpiredMarketNotSettled: u64 = 12;
const EValuationDeadlineNotReached: u64 = 13;
const ENotValuationStarter: u64 = 14;
...
public fun snapshot_expiry_pricer(
    ...
    // business touching. Aborting made a routine race fail the whole flush (RP-31).
