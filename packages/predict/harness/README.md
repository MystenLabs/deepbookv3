...
- `capacity-user-off` — single-leg mints, inventory-impact rate off (user-cost control)
- `capacity-user-on` — single-leg mints at a 2% inventory-impact rate; the keeper create pushes an off-chain 1% ladder
