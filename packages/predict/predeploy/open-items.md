...
- [`p32-ratio-boundaries-2026-08-20.md`](evidence/p32-ratio-boundaries-2026-08-20.md) — absolute-price rungs fail the mass check after one basis point of spot drift; `strike / forward` ratios do not. Source now inverts those ratios on the first charged mint rather than accepting an off-chain cut.
