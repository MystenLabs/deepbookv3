...
| `interval-arithmetic.md` | DRAFT — definitions and doctrine of the envelope-arithmetic rework (DBU-628): the Interval type's soundness contract, storage classes, collapse sites, side doctrine, valuation-pipeline facts | Companion to the rounding policy; becomes settled surface when the rework is accepted |
