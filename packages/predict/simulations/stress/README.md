...
and OOG/abort boundaries. Built during the 2026-06 localnet capacity audit; the findings it
produced live in `.claude/predict-review/OPEN-ITEMS.md` + `.claude/predict-design/audit/`.
