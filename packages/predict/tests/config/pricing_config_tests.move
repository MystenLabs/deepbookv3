...
fun new_returns_correct_defaults() {
    ...
    assert_eq!(config.base_spread(), 20_000_000);
    assert_eq!(config.min_spread(), 5_000_000);
    assert_eq!(config.utilization_multiplier(), 2_000_000_000);
    destroy(config);
}
...
fun set_base_spread_upper_boundary() {
    let mut config = pricing_config::new();
    config.set_base_spread(1_000_000_000);
    assert_eq!(config.base_spread(), 1_000_000_000);
    destroy(config);
}
...
fun set_base_spread_exceeds_max_aborts() {
    let mut config = pricing_config::new();
    config.set_base_spread(1_000_000_001);
...
fun set_min_spread_upper_boundary() {
    let mut config = pricing_config::new();
    config.set_min_spread(1_000_000_000);
    assert_eq!(config.min_spread(), 1_000_000_000);
    destroy(config);
}
...
fun set_min_spread_exceeds_max_aborts() {
    let mut config = pricing_config::new();
    config.set_min_spread(1_000_000_001);
...
fun set_utilization_multiplier_max_u64() {
    let mut config = pricing_config::new();
    config.set_utilization_multiplier(18_446_744_073_709_551_615);
    assert_eq!(config.utilization_multiplier(), 18_446_744_073_709_551_615);
    destroy(config);
}
