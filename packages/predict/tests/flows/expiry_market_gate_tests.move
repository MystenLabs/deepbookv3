...
/// A `redeem_settled` against a still-LIVE (unexpired) market must abort: the
/// settled-redeem path requires the market to be terminally settled, and no
/// settlement transition has run.
