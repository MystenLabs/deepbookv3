...
fun sub_large_values() {
    let (mag, neg) = math::sub_signed_u64(10 * FLOAT, false, 3 * FLOAT, false);
...
fun add_large_same_sign() {
    let (mag, neg) = math::add_signed_u64(5 * FLOAT, false, 3 * FLOAT, false);
...
#[test]
fun cdf_symmetry() {
    // cdf(x) + cdf(-x) = FLOAT for various x
    assert_eq!(math::normal_cdf(0, false) + math::normal_cdf(0, true), FLOAT);
    assert_eq!(math::normal_cdf(HALF, false) + math::normal_cdf(HALF, true), FLOAT);
    assert_eq!(math::normal_cdf(FLOAT, false) + math::normal_cdf(FLOAT, true), FLOAT);
    assert_eq!(math::normal_cdf(2 * FLOAT, false) + math::normal_cdf(2 * FLOAT, true), FLOAT);
    assert_eq!(math::normal_cdf(3 * FLOAT, false) + math::normal_cdf(3 * FLOAT, true), FLOAT);
    assert_eq!(math::normal_cdf(8 * FLOAT, false) + math::normal_cdf(8 * FLOAT, true), FLOAT);
}
