...
// ============================================================
// ln (scipy ground truth — assert_approx_rel)
// ============================================================
...
fun ln_two() {
    ...
    precision::assert_approx_rel(mag, gs::LN2!());
    assert_eq!(neg, false);
}
...
fun ln_four() {
    ...
    precision::assert_approx_rel(mag, gs::LN4!());
    assert_eq!(neg, false);
}
...
fun ln_eight() {
    ...
    precision::assert_approx_rel(mag, gs::LN8!());
    assert_eq!(neg, false);
}
...
fun ln_sixteen() {
    ...
    precision::assert_approx_rel(mag, gs::LN16!());
    assert_eq!(neg, false);
}
...
fun ln_smallest_input() {
    ...
    precision::assert_approx_rel(mag, gs::LN_1E9!());
    assert_eq!(neg, true);
}
...
fun ln_one_point_five() {
    ...
    precision::assert_approx_rel(mag, gs::LN_1_5!());
    assert_eq!(neg, false);
}
...
fun ln_three() {
    ...
    precision::assert_approx_rel(mag, gs::LN_3_0!());
    assert_eq!(neg, false);
}
...
fun ln_five() {
    ...
    precision::assert_approx_rel(mag, gs::LN_5_0!());
    assert_eq!(neg, false);
}
...
fun ln_seven() {
    ...
    precision::assert_approx_rel(mag, gs::LN_7_0!());
    assert_eq!(neg, false);
}
...
fun ln_ten() {
    ...
    precision::assert_approx_rel(mag, gs::LN_10_0!());
    assert_eq!(neg, false);
}
...
fun ln_point_one() {
    ...
    precision::assert_approx_rel(mag, gs::LN_0_1!());
    assert_eq!(neg, true);
}
...
fun ln_point_three() {
    ...
    precision::assert_approx_rel(mag, gs::LN_0_3!());
    assert_eq!(neg, true);
}
...
fun ln_point_seven() {
    ...
    precision::assert_approx_rel(mag, gs::LN_0_7!());
    assert_eq!(neg, true);
}
...
fun ln_near_one_below() {
    ...
    precision::assert_approx_rel(mag, gs::LN_0_999!());
    assert_eq!(neg, true);
}
...
fun ln_near_one_above() {
    ...
    precision::assert_approx_rel(mag, gs::LN_1_001!());
    assert_eq!(neg, false);
}
...
fun ln_hundred() {
    ...
    precision::assert_approx_rel(mag, gs::LN_100_0!());
    assert_eq!(neg, false);
}
...
fun ln_thousand() {
    ...
    precision::assert_approx_rel(mag, gs::LN_1000_0!());
    assert_eq!(neg, false);
}

// ============================================================
// exp (scipy ground truth — assert_approx_rel)
// ============================================================
...
fun exp_ln2_positive() {
    // e^(ln2) = 2.0
    precision::assert_approx_rel(math::exp(gs::LN2!(), false), 2 * FLOAT);
}

#[test]
fun exp_ln2_negative() {
    // e^(-ln2) = 0.5
    precision::assert_approx_rel(math::exp(gs::LN2!(), true), HALF);
}

#[test]
fun exp_2ln2_positive() {
    // e^(2*ln2) = 4.0
    precision::assert_approx_rel(math::exp(gs::LN4!(), false), 4 * FLOAT);
}
...
fun exp_3ln2_positive() {
    // e^(3*ln2) = 8.0
    precision::assert_approx_rel(math::exp(gs::LN8!(), false), 8 * FLOAT);
}
...
fun exp_one_positive() {
    // e^1 = E
    precision::assert_approx_rel(math::exp(FLOAT, false), gs::E!());
}

#[test]
fun exp_one_negative() {
    // e^(-1) = 1/E
    precision::assert_approx_rel(math::exp(FLOAT, true), gs::E_INV!());
}
...
fun exp_tiny_negative() {
    precision::assert_approx_rel(math::exp(1_000_000, true), gs::EXP_NEG_0_001!());
}
...
fun exp_small_negative() {
    precision::assert_approx_rel(math::exp(10_000_000, true), gs::EXP_NEG_0_01!());
}

#[test]
fun exp_point_one_positive() {
    precision::assert_approx_rel(math::exp(TENTH, false), gs::EXP_0_1!());
}

#[test]
fun exp_point_one_negative() {
    precision::assert_approx_rel(math::exp(TENTH, true), gs::EXP_NEG_0_1!());
}

#[test]
fun exp_point_three_positive() {
    precision::assert_approx_rel(math::exp(300_000_000, false), gs::EXP_0_3!());
}

#[test]
fun exp_point_three_negative() {
    precision::assert_approx_rel(math::exp(300_000_000, true), gs::EXP_NEG_0_3!());
}

#[test]
fun exp_half_positive() {
    precision::assert_approx_rel(math::exp(HALF, false), gs::EXP_0_5!());
}

#[test]
fun exp_half_negative() {
    precision::assert_approx_rel(math::exp(HALF, true), gs::EXP_NEG_0_5!());
}

#[test]
fun exp_one_point_five_positive() {
    precision::assert_approx_rel(math::exp(1_500_000_000, false), gs::EXP_1_5!());
}

#[test]
fun exp_one_point_five_negative() {
    precision::assert_approx_rel(math::exp(1_500_000_000, true), gs::EXP_NEG_1_5!());
}

#[test]
fun exp_two_point_five_positive() {
    precision::assert_approx_rel(math::exp(2_500_000_000, false), gs::EXP_2_5!());
}

#[test]
fun exp_two_point_five_negative() {
    precision::assert_approx_rel(math::exp(2_500_000_000, true), gs::EXP_NEG_2_5!());
}
...
// ============================================================
// normal_cdf (scipy ground truth — assert_approx_rel)
// ============================================================

#[test]
fun cdf_zero_positive() {
    // Φ(0) = 0.5; Abramowitz polynomial produces ~2 units error
    precision::assert_approx_rel(math::normal_cdf(0, false), gs::PHI_0!());
}

#[test]
fun cdf_zero_negative() {
    precision::assert_approx_rel(math::normal_cdf(0, true), gs::PHI_NEG_0!());
}
...
fun cdf_point_zero_five() {
    precision::assert_approx_rel(math::normal_cdf(50_000_000, false), gs::PHI_0_05!());
}

#[test]
fun cdf_point_seven_five() {
    precision::assert_approx_rel(math::normal_cdf(750_000_000, false), gs::PHI_0_75!());
    precision::assert_approx_rel(math::normal_cdf(750_000_000, true), gs::PHI_NEG_0_75!());
    assert_eq!(math::normal_cdf(750_000_000, false) + math::normal_cdf(750_000_000, true), FLOAT);
}

#[test]
fun cdf_one_point_five() {
    precision::assert_approx_rel(math::normal_cdf(1_500_000_000, false), gs::PHI_1_5!());
    precision::assert_approx_rel(math::normal_cdf(1_500_000_000, true), gs::PHI_NEG_1_5!());
}

#[test]
fun cdf_two_point_five() {
    precision::assert_approx_rel(math::normal_cdf(2_500_000_000, false), gs::PHI_2_5!());
    precision::assert_approx_rel(math::normal_cdf(2_500_000_000, true), gs::PHI_NEG_2_5!());
}
