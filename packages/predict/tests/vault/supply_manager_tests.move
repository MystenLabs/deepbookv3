...
// Note: EZeroSharesBurned is unreachable — withdraw requires amount > 0, the user
// must have shares (so total_shares > 0), and mul_div_round_up guarantees result >= 1.
// The assert exists as a defensive guard.
