...
/// Account-owner authority is enforced on the live mint entrypoint: a sender who
/// does not own the account cannot mint against it even with a valid market and
/// non-binding slippage.
#[test_only]
module deepbook_predict::scope_flow__intent_guard__mint_authority_tests;
...
fun non_owner_cannot_mint_on_another_account() {
    ...
    // Alice owns and funds the account.
    ...
    // Bob, who does not own the account, attempts to mint against it.
