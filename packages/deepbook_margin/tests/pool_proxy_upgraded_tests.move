...
#[test, expected_failure(abort_code = pyth_upgraded::pyth::E_STALE_PRICE_UPDATE)]
fun place_limit_order_v2_upgraded_with_debt_rejects_a_stale_quote_feed() {
    let (
        mut scenario,
        clock,
        admin_cap,
...
#[test, expected_failure(abort_code = pyth_upgraded::pyth::E_STALE_PRICE_UPDATE)]
fun place_market_order_v2_upgraded_with_debt_rejects_a_stale_quote_feed() {
    let (
        mut scenario,
        clock,
        admin_cap,
...
#[test, expected_failure(abort_code = pyth_upgraded::pyth::E_STALE_PRICE_UPDATE)]
fun place_market_order_and_repay_loan_upgraded_with_debt_rejects_a_stale_quote_feed() {
    let (
        mut scenario,
        clock,
        admin_cap,
...
#[test, expected_failure(abort_code = pyth_upgraded::pyth::E_STALE_PRICE_UPDATE)]
fun place_reduce_only_limit_order_v2_upgraded_rejects_a_stale_quote_feed() {
    let (
        mut scenario,
        clock,
        admin_cap,
...
#[test, expected_failure(abort_code = pyth_upgraded::pyth::E_STALE_PRICE_UPDATE)]
fun place_reduce_only_market_order_v2_upgraded_rejects_a_stale_quote_feed() {
    let (
        mut scenario,
        clock,
        admin_cap,
...
#[test, expected_failure(abort_code = pyth_upgraded::pyth::E_STALE_PRICE_UPDATE)]
fun place_reduce_only_limit_order_and_repay_loan_upgraded_rejects_a_stale_quote_feed() {
    let (
        mut scenario,
        clock,
        admin_cap,
...
#[test, expected_failure(abort_code = pyth_upgraded::pyth::E_STALE_PRICE_UPDATE)]
fun place_reduce_only_market_order_and_repay_loan_upgraded_rejects_a_stale_quote_feed() {
    let (
        mut scenario,
        clock,
        admin_cap,
...
#[test, expected_failure(abort_code = pyth_upgraded::pyth::E_STALE_PRICE_UPDATE)]
fun update_current_price_upgraded_rejects_a_stale_quote_feed() {
    let (
        mut scenario,
        clock,
        admin_cap,
    ...
    destroy_2!(usdc_price, stale_usdt);
    return_shared(pool);
    cleanup_margin_test(registry, admin_cap, maintainer_cap, clock, scenario);
}
