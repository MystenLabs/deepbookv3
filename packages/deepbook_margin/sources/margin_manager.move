...
public struct LiquidationEvent has copy, drop {
    ...
    debt_is_base: bool,
    base_asset_type: TypeName,
    quote_asset_type: TypeName,
    pool_reward: u64,
    pool_default: u64,
    risk_ratio: u64,
...
public fun withdraw<BaseAsset, QuoteAsset, WithdrawAsset>(
    ...
    event::emit(WithdrawCollateralEvent {
        ...
        withdraw_base_asset,
        base_asset_type: type_name::with_defining_ids<BaseAsset>(),
        quote_asset_type: type_name::with_defining_ids<QuoteAsset>(),
        remaining_base_asset,
        remaining_quote_asset,
        remaining_base_debt,
        remaining_quote_debt,
