...
module deepbook::master_tests {
    ...
    //     let pool1_id = setup_pool_with_default_fees<SUI, USDC>(OWNER, registry_id, &mut test);
    ...
    //     let order_info_1 = pool_tests::place_limit_order(
    //         pool1_id,
    //         ALICE,
    ...
    //     // 1 SUI in ask, 2 USDC in bid
    //     // 2 SUI total with 0.05% maker fees, 1_000_000 * 10 = 10_000_000 in fees in deep
    //     check_balance(
    //         ALICE,
    //         alice_balance_manager_id,
