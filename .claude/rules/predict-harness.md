...
- Treat `packages/predict/deployment/deployment.testnet.json` as an integration fixture, never as
  harness-owned runtime state. The harness must not write the deployment operator journal.
