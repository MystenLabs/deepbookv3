...
type CoinScalarsType = {
    [key: string]: number;
    FLOAT_SCALAR: number;
    POOL_CREATION_FEE: number;
    LARGE_TIMESTAMP: number;
    GAS_BUDGET: number;
};
...
export const COIN_SCALARS: CoinScalarsType = {
    ...
    POOL_CREATION_FEE: 10000 * 1000000, // Adjust based on DEEP_SCALAR
    LARGE_TIMESTAMP: 1844674407370955161,
    GAS_BUDGET: 0.5 * 1000000000 // Adjust based on SUI_SCALAR
};
