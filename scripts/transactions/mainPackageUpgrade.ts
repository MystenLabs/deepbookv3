...
const mainPackageUpgrade = async () => {
    ...
    const suiFolder = process.env.ORIGIN === 'gh_action' ? '../home/linuxbrew/.linuxbrew/bin/sui' : 'sui';
	const upgradeCall = `../home/linuxbrew/.linuxbrew/bin/sui client upgrade --upgrade-capability ${upgradeCapID[network]} --gas-budget 3000000000 --gas ${gasObjectId} --skip-dependency-verification --serialize-unsigned-transaction`;
