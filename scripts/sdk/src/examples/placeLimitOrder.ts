...
export const placeLimitOrderClient = async () => {
    ...
    await dbClient.depositIntoManager(1, deepAddress);
...
export const placeLimitOrderPTB = async () => {
    ...
    depositIntoManager(balanceManagerAddress, 1, deepCoin, txb);
    // explicitely set order type, self matching, and payWithDeep
    placeLimitOrder(deepdbusdcPool, balanceManagerAddress, 12345, 1, 1, false, 0, 0, true, txb);
